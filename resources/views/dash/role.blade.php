              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                   <div class="panel-body">
                      <form  method="post" novalidate="" action="{{ url('addrole')}}" role="form" class="form-horizontal">
                        {{ csrf_field() }}
                        <div class="form-group">
                          <label class="col-md-2 control-label">Role</label>
                          <div class="col-md-10">
                            <input type="text" required="" placeholder="role" id="ITEMS" class="form-control" name="role">
                          </div>
                        </div>
                        <div class="form-group">
